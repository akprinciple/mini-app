...
<x-layout>
    <x-slot:title>Agricultural Produce Ecommerce &amp;</x-slot:title>
            ...
            <div class="container">
              <div class="row flex-center">
                ...
                <div class="col-md-7 col-lg-6 py-8 text-md-start text-center">
                  <h1 class="display-1 fs-md-5 fs-lg-6 fs-xl-6 text-light">Looking for Less Expensive Foodstuffs?</h1>
                  <h1 class="text-800 mb-5 fs-4">We are connecting final consumers to producers <br class="d-none d-xxl-block" /></h1>
